...
#pragma warning restore CS8618
        ...
        public static List<string> AllEnglishWords = new();
        public static List<string> DoodleWords = new();
        public static Dictionary<int, List<string>> WordsByLength = new();
        ...
        private static void Init(object? sender, GameHost e) {
            ...
            if (File.Exists("./data/save.json")) {
                SaveFile = Helper.DeserializeFromFile<SaveFile>("./data/save.json");
                SaveFile.ApplySaves();
            } else {
                SaveFile = new();
            }
        ...
        public static void ManualSave() {   
            Helper.SerializeToFile(SaveFile, "./data/save.json");
        }
    }
}
