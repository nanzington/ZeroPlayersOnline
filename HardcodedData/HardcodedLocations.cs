    ...
    public class HardcodedLocations {
        public static void InitLocs(Dictionary<string, Location> Atlas, Dictionary<string, GatheringTile> Gathers, Dictionary<string, AreaMonster> Monsters) {
            ...
            locsToAdd.Add(new Location() {
                ...
                ID = "TI_Main",
                ConnectedLocations = new List<string>() { "TI_Bank", "TI_Cavern", "TI_Kitchen", "TI_Temple", "TI_WizardHut" },
            ...
            locsToAdd.Add(new Location() {
                ...
                ID = "TI_Bank",
                ConnectedLocations = new List<string>() { "TI_Main" },
                IsBank = true
            });
            ...
            locsToAdd.Add(new Location() {
                ...
                ID = "TI_Cavern",
                ConnectedLocations = new List<string>() { "TI_Main", "TI_Newts" },
            ...
            locsToAdd.Add(new Location() {
                ...
                ID = "TI_Newts",
                ConnectedLocations = new List<string>() { "TI_Cavern" },
