...
namespace ZeroPlayersOnline.Hardcodes {
    public class HardcodedLocationsTutorial {
        public static void InitLocs(Dictionary<string, Location> Atlas, Dictionary<string, GatheringTile> Gathers, Dictionary<string, AreaMonster> Monsters) {
            ...
            locsToAdd.Add(new Location("TI_Main", "Tutorial Island", "Tutorial Island") { 
                ...
                GatheringSpots = new() { "treePine", "treePine", "treePine", "treePine", "treePine", "treePine", "treePine", "fishNetSmall", "fishNetSmall" },
                NPCsHere = new() { "tutorFarming", "tutorFishing", "tutorSlayer", "man", "man", "man", "tiForlornGhost2" },
                AreaMonsters = new() { "man", "man", "man" },
                FarmingPatchesHere = new() { "TI_allotment1", "TI_allotment2", "TI_allotment3" }, 
            ...
            locsToAdd.Add(new Location("TI_AirAltar", "Air Altar", "Tutorial Island") { 
                ...
                ProcessingStations = new() { "Air Altar" },
                NPCsHere = new() { "tutorRunecrafting" },
                GatheringSpots = new() { "plantFlax", "plantFlax", "plantFlax", "plantFlax" }
            });
